        ...
        <div className="Flex min-h-screen bg-slate-100 dark:bg-slate-900 flex justify-around px-4">
            ...
            <main className='mt-32 w-full bg-slate-100 dark:bg-slate-900 '>
                ...
                <div className="flex flex-wrap gap-4 w-full ">
                    ...
                    <div className='flex gap-2 w-2/3 md:w-1/3 lg:w-1/5 rounded-lg bg-white  justify-around items-center bg-light dark:bg-dark shadow'>
                        <div className='rounded-full m-1 md:h-12 md:w-12 h-6 w-6 flex items-center justify-center bg-sky-500 text-white'>
                        <MdAttachMoney className='md:h-8 md:w-8'></MdAttachMoney>
                        </div>
                        <div className='pl-1 m-1'>
                ...
                <input type="submit" 
                        value="Verificar conexão"
                        onClick={() => envia('55AA0000','10.1.21.12','2002')}
                ...
                <input type="submit" 
                        value="Liga Rele 1"
                        onClick={() => envia('55AA0306020000000101','10.1.21.19','2002')}
                        className="cursor-pointer w-full p-2 bg-green-500 rounded font-medium" />
                
                <input type="submit" 
                        value="Desliga Rele 1"
                        onClick={() => envia('55AA0306010000000101','10.1.21.19','2002')}
                        className="cursor-pointer w-full p-2 bg-green-500 rounded font-medium" />

                <input type="submit" 
                        value="Aciona 01"
                        onClick={() => envia('55AA0306060000000101','10.1.21.19','2002')}
                        className="cursor-pointer w-full p-2 bg-green-500 rounded font-medium" />
                ...
                <input type="submit" 
                        value="Liga Rele 2"
                        onClick={() => envia('55AA0306100000000101','10.1.21.19','2002')}
                        className="cursor-pointer w-full p-2 bg-green-500 rounded font-medium" />
                
                <input type="submit" 
                        value="Desliga Rele 2"
                        onClick={() => envia('55AA0306080000000101','10.1.21.19','2002')}
                        className="cursor-pointer w-full p-2 bg-green-500 rounded font-medium" />
                
                <input type="submit" 
                        value="Aciona 02"
                        onClick={() => envia('55AA0306300000000101','10.1.21.19','2002')}
                        className="cursor-pointer w-full p-2 bg-green-500 rounded font-medium" />
                ...
                <input type="submit" 
                        value="Pino 7 Ativar"
                        onClick={() => envia('55AA0306000000020101','10.1.21.19','2002')}
                        className="cursor-pointer w-full p-2 bg-green-500 rounded font-medium" />

                <input type="submit" 
                        value="Pino 7 Desativar"
                        onClick={() => envia('55AA0306000000010101','10.1.21.19','2002')}
                        className="cursor-pointer w-full p-2 bg-green-500 rounded font-medium" />   
                ...
                <input type="submit" 
                        value="Pino 8 Ativar"
                        onClick={() => envia('55AA0306000000080101','10.1.21.19','2002')}
                        className="cursor-pointer w-full p-2 bg-green-500 rounded font-medium" />

                <input type="submit" 
                        value="Pino 8 Desativar"
                        onClick={() => envia('55AA0306000000040101','10.1.21.19','2002')}
                        className="cursor-pointer w-full p-2 bg-green-500 rounded font-medium" />   
                ...
                <input type="submit" 
                        value="Pino 9 Ativar"
                        onClick={() => envia('55AA0306000080000101','10.1.21.19','2002')}
                        className="cursor-pointer w-full p-2 bg-green-500 rounded font-medium" />

                <input type="submit" 
                        value="Pino 9 Desativar"
                        onClick={() => envia('55AA0306000040000101','10.1.21.19','2002')}
                        className="cursor-pointer w-full p-2 bg-green-500 rounded font-medium" />   
                ...
                <div className="flex gap-2 w-1/5 ">
                <input type="submit" 
                        value="Pino 10 Ativar"
                        onClick={() => envia('55AA0306000020000101','10.1.21.19','2002')}
                        className="cursor-pointer w-full p-2 bg-green-500 rounded font-medium" />

                <input type="submit" 
                        value="Pino 10 Desativar"
                        onClick={() => envia('55AA0306000010000101','10.1.21.19','2002')}
                        className="cursor-pointer w-full p-2 bg-green-500 rounded font-medium" />   
                ...
                <input type="submit" 
                        value="Led 03 ativar"
                        onClick={() => envia('55AA0306000200000101','10.1.21.19','2002')}
                        className="cursor-pointer w-full p-2 bg-green-500 rounded font-medium" />

                <input type="submit" 
                        value="Led 03 desativar"
                        onClick={() => envia('55AA0306000100000101','10.1.21.19','2002')}
                        className="cursor-pointer w-full p-2 bg-green-500 rounded font-medium" />
                </div>
                ...
                <input type="submit" 
                        value="Led 02 ativar"
                        onClick={() => envia('55AA0306800000000101','10.1.21.19','2002')}
                        className="cursor-pointer w-full p-2 bg-green-500 rounded font-medium" />   
                
                <input type="submit" 
                        value="Led 02 desativar"
                        onClick={() => envia('55AA0306400000000101','10.1.21.19','2002')}
                        className="cursor-pointer w-full p-2 bg-green-500 rounded font-medium" />
                </div>
                ...
                <input type="submit" 
                        value="Comando"
                        onClick={() => envia('55AA0200','10.1.21.13','2002')}
                        className="cursor-pointer w-full p-2 bg-green-500 rounded font-medium" />
                </div>
                    <h2 className="text-lg font-bold text-black dark:text-white">Resposta:</h2>
                    <p className="text-black dark:text-white">{resposta}</p>
                </div>
                </section>
            </main>
        </div>
